...
struct EditRecipeView: View {
    ...
    @StateObject var vm = EditRecipeViewModel(recipe: Recipe(title: "", ingredients: "", steps: "", image: "", recipetype: "", duration: "", difficulty: 1.0))
...
//                    .frame(height: 200)
                    ...
                    Button(action: {
                        vm.editRecipe(editedRecipe: vm.newRecipe)
                    }, label: {
